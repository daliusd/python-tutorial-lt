...
.. glossary::
   ...
   deskriptorius / descriptor
      ...
      deskriptorius, tai jo specialūs metodai kviečiami kai atributas yra
      pasiekiamas. Paprastai norint gauti, nustatyti ar ištrinti *a.b*
      atributą yra ieškoma objekto *b* klasės *a* žodyne, bet jei *b* yra
      deskriptorius yra iškviečiamas atitinkamas deskriptoriaus metodas.
      Deskriptorių supratimas yra reikalingas išsamiam Pitono supratimui, nes
      jie yra pagrindas daugeliui savybių: funkcijoms, metodas, savybėms,
   ...
   dokumentavimo eilutė / docstring
      ...
      vykdomas, jį atpažįsta kompiliatorius ir yra nustatomas į
      :attr:`__doc__` atributą. Kadangi jis yra pasiekiamas naudojant
      introspekciją, tai yra įprasta vieta objektų dokumentavimui.
   ...
   EAFP
      ...
      stiliumi daroma prielaida, kad raktai ar atributai egzistuoja ir gaudo
      išimtis, jei prielaida yra neteisinga. Šis švarus ir greitas stilius
   ...
   reiškinys / expression
      ...
      reiškinys yra tokių elementų kaip vardai, atributų pasiekimų, operatorių
      arba funkcijų kvietimų junginys, kuris gražina reikšmę. Kaip kontrastas
      daugeliui kitų programavimo kalbų ne visos Pitono konstrukcijos yra
      reiškiniai. Taip yra yra :term:`sakinys`, kuris negali būti naudojamas
      kaip reiškinys. Pvz.: raktiniai žodžiai :keyword:`print` arba :keyword:`if`.
      Priskyrimai taip pat yra sakiniai, o ne reiškiniai.
   ...
   funkcija / function
      Sakinių grupė kuri sugrąžina reikšmę. Funkcijai gali būti perduoti
   ...
   šiukšlių surinkimas / garbage collection
      ...
      pabaigti rodyklių ciklus.

   generatorius / generator
      Funkcija, kuri sugrąžina iteratorių. Ji panaši į normalią funkciją
      išskyrus tai, kad jos reikšmės yra sugrąžinamos naudojant
      ...
      (sugrąžinant rezultatą) ir atstatomas, kai pareikalaujama sekančio
      elemento iškviečiant sugrąžinto iteratoriaus :meth:`next` metodą.
   ...
   maišomas / hashable
      ...
      reikšmes lyginant turi turėti tokią pačia maišos reikšmę.

      Maišomumas leidžia objektą naudoti žodynuose ir aibėse, nes šios
      duomenų struktūros naudoja maišos reikšmes.

      Visi Pitono
      All of Python's nekintami objektai yra maišomi, kai tuo tarpų kintami
      objektai nėra (pvz.: konteineriai - sąrašai arba žodynai).
      Objektai, kuria yra sukuriami iš vartotojo apibrėžtų klasių yra
      maišomi visada, nes jie niekada nėra lygus ir jų maišos reikšmė
      yra jų :func:`id`.
   ...
   nekintamas / immutable
      Objektas su fixuota reikšme. Nekintamais objektais gali būti skaičiai, eilutės
      ir kortežai. Tokie objektai negali būti keičiami. Turi būti sukurtas naujas
   ...
   sveikųjų skaičių dalybą / integer division
      ...
      vietoje ``/`` operatoriaus.  Taip pat žiūrime :term:`__future__`.

   interaktyvus / interactive
      Pitonas turi interaktyvų interpretatorių, o tai reiškia, kad
      sakinius ir reiškinius galima įvedinėti interpretatoriaus
   ...
   iteruojamas / iterable
      Objektas, kuri gali grąžinti savo norius po vieną.
      ...
      metodus. Iteruojami objektai glai būti naudojami :keyword:`for` cikle ir
      daugelyje kitų vietų, kur reikalingos sekos (:func:`zip`, :func:`map`, ...).
      Kai iteruojamas objektas kaip argumentas perduodamas funkcijai
      :func:`iter`, ji grąžina objektui iteratorių. Šis iteratorius yra
      naudingas, kai reikia pereiti per aibės reikšmes. Kai naudojami
      iteruojami objektai nėra būtina kviesti :func:`iter` ar tvarkytis su iteratoriaus
      objektu pačiam. ``for`` sakinys tai atlieka automatiškai sukurdamas laikiną
      bevardį kintamąjį, kuriame laikomas iteratorius ciklui.
      Taip pat žiūrėti: :term:`iteratorius`, :term:`seka`, ir :term:`generatorius`.

   iteratorius / iterator
      Objektas, kuris reprezentuoja duomenų srautą. Pakartotini iteratoriaus
      metodo :meth:`next` kvietimai sugrąžina sekantį narį sraute. Kai daugiau
      ...
      kitose vietoje, kuri reikalingi iteruojami objektai. Viena pažymėtina
      išimtis yra kodas, kuris bando įvydykti kelis iteracijos žingsnius.
      Konteinerio objektas (pvz.: :class:`list`) sugrąžina naują iteratorių
      kiekvieną kartą, kai jį perduodi :func:`iter` funkcijai arba naudoji
      :keyword:`for` cikle.  Bandymai atliktį tą patį su iteratoriumi
   ...
   vardinis argumentas / keyword argument
      ...
      Kintamas vardas priskiriamas lokaliam vardui funkcijoje, kuriam
      bus priskirta reikšmė. ``**`` naudojamas vardinių argumentų priėmimui
      arba perdavimui. Daugiau :term:`argumentas`.

   lambda
      Anoniminė vienos eilutės funkcija susidedanti iš vieno reiškinio, kuri
      yra apskaičiuojama, kai yra kviečiama. Lambda funkcijų sintaksė yra
   ...
   sąrašas / list
      Standarinė Pitono :term:`seka`. Nepaisant pavadinimo jis artimesnis kitų
   ...
   sąrašo užklausa / list comprehension
      ...
      duotame pavyzdyje visi elementai iš aibės nuo 0 iki 255 bus apdoroti.
   ...
   metaklasė / metaclass
      ...
      šiuo atveju yra išskirtinis, nes jame galim sukurti savo metaklases.
      Daugumai vartotojų niekada nereikia šios priemonės, bet kai
      poreikis atsiranda metaklasės gali pasiūlyti galingus ir elegantiškus
      sprendimus. Jos yra naudojamos atributų pasiekimo žurnalų rašymui,
      gijų-saugumo įgyvendinime, objektų sukūrimo sekimui, singltonu
   ...
   vardinis kortežas / named tuple
      ...
      Visas savybes turintį vardinį kortežą galim sukurti naudojantis
   ...
   vardų erdvė / namespace
      ...
      žodynai. Egzistuoja lokali, globali ir įtaisytoji ervės bei
      vidinės erdvės objektuose (arba metoduose). Vardinės ervės
      suteikia modularumą, kuris padeda išvengti vardų konflikto.
      ...
      priklauso funkcijai. Pavyzdžiui rašydami :func:`random.seed` ir
   ...
   pozicinis argumentas / positional argument
      ...
      kaip sąrašą funkcijai. Žiurėti :term:`argumentas`.
   ...
   pitoniškas / Pythonic
      Idėja arba kodo gabalas, kuris atitinka dauguma Pitono kalbos idiomų
      užuot įgyvendina kodą naudojant koncepcija iš kitų kalbų. Pavyzdžiui
   ...
   rodyklių skaičius / reference count
      ...
      apibrėžia :func:`getrefcount` funkciją, kuria programuotojai gali
   ...
   __slots__
      ...
      kuris saugo atmintį apibrėžiant erdvė egzemplioriaus atributams ir
      panaikinant egzemplioriaus žodynus. Nors technika yra populiari kartais
   ...
   seka / sequence
      :term:`iteruojamas` objektas, kuris palaiko efektyvų elekemtų pasiekimą
   ...
   sakinys / statement
      Sakinys yra kodo bloko dalis. Sakinys yra arba 
      :term:`reiškinys` arba viena iš kelių konstrukcijų su raktiniu
      žodžiu (pvz.: :keyword:`if`, :keyword:`while` arba :keyword:`print`).

   eilutė su trigubomis kabutėmis / triple-quoted string
      Eilutė, kuri yra apsupta trimis kabutėmis (") arba apostrofais (').
      Nors juose nėra jokio funkcionalumo, kurio negalima būtų padaryti
   ...
   tipas / type
      Pitono objekto tipas nustato koks tai objektas yra. Kiekvienas objektas
   ...
   virtualioji mašina / virtual machine
      ...
      mašina vykdo :term:`baitinį kodą` sugeneruota baitinio kodo
      kompiliatoriaus.

   Pitono Zen / Zen of Python
      Pitono dizaino principų ir filosofijų sąrašas kuris padeda suprasti
      ir naudoti kalbą. Sąrašą galima rasti surinkus
      "``import this``" interaktyviajame raginime.
